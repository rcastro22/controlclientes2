											...
											<div class="row">
												<div class="col-lg-offset-9 col-lg-3">
													<div class="form-group <?php if(form_error('montodescuento')) echo 'has-error'; ?>">
														...
														<input class="form-control" type="text" name="montodescuento" id="montodescuento" value="<?php echo set_value('montodescuento'); ?>" maxlength="10">
														</div>
											...
											<div class="row">
												<div class="col-lg-offset-7 col-lg-5">
													<div class="form-group <?php if(form_error('descripciondescuento')) echo 'has-error'; ?>">
														...
														<input class="form-control" type="text" name="descripciondescuento" id="descripciondescuento" value="<?php echo set_value('descripciondescuento'); ?>" maxlength="60">
