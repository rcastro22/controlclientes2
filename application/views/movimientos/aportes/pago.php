<?php echo $headermov;?>
			...
			<div class="col-lg-10 col-lg-offset-1" >
				<div class="panel panel-default">
			  	<!-- Default panel contents -->
			  		<div class="panel-heading panel-heading-extras" > Datos aporte  </div>
								...
								<div>									
									<div class="col-lg-4 form-horizontal">
										<div class="form-group <?php if(form_error('idaporte')) echo 'has-error'; ?>">
											<label class="col-lg-5 control-label" for="name"> Aporte: </label>
											<div class="col-lg-7">
												<input class="form-control" readonly type="text" name="idaporte" id="idaporte" value="<?php echo $datosaporte->idaporte; ?>" maxlength="30">
									...
									<!--<div class="col-lg-4">
										<div class="form-group <?php if(form_error('reserva')) echo 'has-error'; ?>">
											...
											<input class="form-control" type="text" name="reserva" id="reserva" value="<?php echo $datosaporte->reserva; ?>" maxlength="10">
									...
									<div class="col-lg-4 col-lg-offset-4 form-horizontal">
										<div class="form-group">
											...
											<label class="col-lg-5 control-label" for="name"> Inversionista: </label>
											<div class="col-lg-7">
							...
							<!--<form action="<?php echo site_url('movimientos/negociacion/pago'); ?>" method="post">-->
								...
								<div class="row">
									<div class="col-lg-4 col-lg-offset-4">
										<div class="form-group">
											<label class="radio-inline"><input type="radio" name="optradio" value="interes" checked>Interés</label>
											<label class="radio-inline"><input type="radio" name="optradio" value="capital">Capital</label>									
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-11">
										<div class="row">
											<div class="col-lg-3">
												<div class="form-group">
													<input type="hidden" name="hformapago" id="hformapago" value="<?php echo $datosaporte->idproyecto; ?>" />
	...
	<script src="<?php echo base_url().'assets/js/movimientos/aportes/pago.js';?>"></script> 
