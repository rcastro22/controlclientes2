							...
							<div>								
								<div class="col-lg-6 form-horizontal">
									<div class="form-group">
										<label class="control-label col-lg-3" for="name"> Aporte: </label>						
										<div class="col-lg-9">
											<input readonly type="text" class="form-control" name="idaporte" id="idaporte" value="<?php echo $idaporte; ?>" />												
										</div>
									</div>
								</div>	
								<div class="col-lg-6 form-horizontal">
										<div class="form-group">
											...
											<label class="col-lg-3 control-label" for="name"> Inversionista: </label>
											<div class="col-lg-9">
			...
			<div class="panel panel-default">
	  			...
	  			<div class="panel-body" style="overflow-x: auto">
					...
					<table class="table table-striped table-bordered table-hover tabla" data-orden="true" data-filtro="true" data-fuente="dtLlenar" id="gvBuscar">
						<thead>
		    				<tr>
			              				<th class="hide" data-tipo="string" data-campo="idnegociacion" data-alineacion="izquierda" style="text-align:center">APORTE</th>
			              				...
			              				<th data-tipo="string" data-campo="tipopago" data-alineacion="izquierda" style="text-align:center">TIPO DE PAGO</th>
...
<script src="<?php echo base_url().'assets/js/movimientos/pagosaporte/listado.js';?>"></script> 
