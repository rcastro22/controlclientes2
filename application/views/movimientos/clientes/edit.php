								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											<input type="hidden" name="htipoidentificacion" id="htipoidentificacion" value="<?php echo $datoscliente->idtipoidentificacion; ?>" />
											<label class="control-label" for="name"> Tipo Identificación: </label>
											<select class="form-control" name="tipoidentificaciones" id="tipoidentificaciones"></select>			
										</div>
									</div>
									<div class="col-lg-4">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group <?php if(form_error('correo')) echo 'has-error'; ?>">
											...
											<input class="form-control" type="text" name="correo" id="correo" value="<?php echo $datoscliente->correo; ?>" maxlength="100">
								...
								<div class="row">
									...
									<div class="col-lg-2">
										<div class="form-group <?php if(form_error('ingresos')) echo 'has-error'; ?>">
											...
											<span id="spaningresos" name="spaningresos" class="input-group-addon">$.</span>
								...
								<div class="row">
									...
									<div class="col-lg-2">
										<div class="form-group <?php if(form_error('otrosingresos')) echo 'has-error'; ?>">
											...
											<div class="input-group">
											<span id="spanotrosing" name="spanotrosing" class="input-group-addon">$.</span>
