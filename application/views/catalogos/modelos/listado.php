<?php echo $headercat;?>
				...
				<div class="panel panel-default">
			  	<!-- Default panel contents -->
			  		<div class="panel-heading panel-heading-extras" height="30px"> 
			  			<?php echo $page_title;?>  
			  			<a href="<?php echo base_url().'catalogos/modelo/nuevo';?>" class="btn btn-negro pull-right" style="padding-top: 0; padding-bottom: 0; vertical-align: middle;">Nuevo</a>			  			
			  		</div>
		  			<div class="panel-body" style="overflow-x: auto">
        				...
        				<table id="gvBuscar" class="table table-striped table-bordered table-hover tabla" data-orden="true" data-filtro="true" data-fuente="dtLlenar">
							<thead>
			    				<tr>
                      				<th data-tipo="int" data-campo="idmodelo" data-alineacion="centro" style="text-align:center">CODIGO</th>
	...
	<script src="<?php echo base_url().'assets/js/catalogos/modelos/listado.js';?>"></script> 
<?php echo $footer;?>
