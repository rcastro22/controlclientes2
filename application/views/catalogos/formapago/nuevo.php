			  	...
			  	<!-- Default panel contents -->
			  		<div class="panel-heading" > <?php echo $page_title;?>  </div>
			  			<div class="panel-body">
							...
							<form action="<?php echo site_url('catalogos/formapago/nuevo'); ?>" method="post">
								...
								<div class="form-group <?php if(form_error('descripcion')) echo 'has-error'; ?>">
									...
									<input class="form-control" type="text" name="descripcion" id="descripcion" value="<?php echo set_value('descripcion'); ?>" maxlength="20">
