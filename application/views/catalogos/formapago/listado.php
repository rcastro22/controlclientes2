<?php echo $headercat;?>
			...
			<div class="col-lg-10 col-lg-offset-1">
				...
				<!-- Default panel contents -->
			  		<div class="panel-heading panel-heading-extras" height="30px"> 
			  			<?php echo $page_title;?>  
			  			<a href="<?php echo base_url().'catalogos/formapago/nuevo';?>" class="btn btn-negro pull-right" style="padding-top: 0; padding-bottom: 0; vertical-align: middle;">Nuevo</a>
			  		</div>
		  			<div class="panel-body">
						...
						<table class="table table-striped table-bordered table-hover tabla" data-orden="true" data-filtro="true" data-fuente="dtLlenar" id="gvBuscar">
							<thead>
			    				<tr>
		              				<th data-tipo="string" data-campo="idformapago" data-alineacion="izquierda" style="text-align:center">CODIGO</th>
		              				<th data-tipo="string" data-campo="descripcion" data-alineacion="izquierda" style="text-align:center">DESCRIPCION</th>
	...
	<script src="<?php echo base_url().'assets/js/catalogos/formapago/listado.js';?>"></script> 
