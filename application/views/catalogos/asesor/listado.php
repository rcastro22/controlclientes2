		...
		<div class="col-lg-10 col-lg-offset-1">
			<div class="panel panel-default">
		  		<div class="panel-heading panel-heading-extras" height="30px"> 
		  			<?php echo $page_title;?>  
		  			<a href="<?php echo base_url().'catalogos/asesor/nuevo';?>" class="btn btn-negro pull-right" style="padding-top: 0; padding-bottom: 0; vertical-align: middle;">Nuevo</a>
		  		</div>
	  			<div class="panel-body">
					<div class="form-search pull-right input-group" data-tabla="gvBuscar">
						...
						<thead>
		    				<tr>
	              				<th data-tipo="string" data-campo="idasesor" data-alineacion="izquierda" style="text-align:center">CODIGO</th>
...
<script src="<?php echo base_url().'assets/js/catalogos/asesor/listado.js';?>"></script> 
