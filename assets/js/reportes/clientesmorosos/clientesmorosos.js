...
$("#btnConsultar").click(function() {   
	$("#gvBuscar").tabla(base_url+'reportes/clientesmorosos/getClientesMorosos/'+$("#proyectos").val());
	$("#gvBuscarTotales").tabla(base_url+'reportes/clientesmorosos/getClientesMorososTotales/'+$("#proyectos").val());
